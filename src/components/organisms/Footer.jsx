    ...
    <footer className="bg-white flex justify-center items-center py-10 px-7 text-poppins">
      <div className="max-w-[100rem] w-full">
        <div className="w-full flex xl:flex-row gap-10 xl:gap-0 flex-col justify-around items-center xl:items-start">
          <div className="xl:w-1/2 w-full flex flex-col justify-center items-center gap-4">
            <Logo
            ...
            <p className="max-w-xs mt-3 text-justify">
              Jl. Garuda No. 1, Lempeh, Kecamatan Sumbawa, Kabupaten Sumbawa,
              Nusa Tenggara Barat. 84316
            </p>

            <p className="font-medium mt-6">Ikuti Sosial Media Kami</p>
