        ...
        <table className="table-auto w-full border-collapse border border-gray-200">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="border border-gray-200 px-4 py-2">Judul Dokumen</th>
              <th className="border border-gray-200 px-4 py-2">Nomor Peraturan</th>
              <th className="border border-gray-200 px-4 py-2">Produk Hukum</th>
              <th className="border border-gray-200 px-4 py-2">Tahun Peraturan</th>
              <th className="border border-gray-200 px-4 py-2">Tanggal Upload</th>
            ...
            {documents.length > 0 ? (
              documents.map((doc, index) => (
                <tr key={doc.id} className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-200 px-4 py-2">{doc.regulationNumber}</td>
                  <td className="border border-gray-200 px-4 py-2">{doc.legalProduct}</td>
                  <td className="border border-gray-200 px-4 py-2 text-center">{doc.year}</td>
                  <td className="border border-gray-200 px-4 py-2 text-center">{doc.uploadDate}</td>
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700">Nomor Peraturan</label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700">Produk Hukum</label>
              <select
                name="legalProduct"
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700">Tahun Peraturan</label>
              <select
                name="year"
                value={formData.year}
                onChange={handleInputChange}
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              >
                {Array.from({ length: 2025 - 1945 + 1 }, (_, i) => 1945 + i).map((year) => (
